...
library(car)
library(magrittr)
monthly <- read_excel("C:/Users/SMcRae/udacity-git-course/masters_projects/rainfall_comparison/monthly_differences.xlsx")
daily   <- read_excel("C:/Users/SMcRae/udacity-git-course/masters_projects/rainfall_comparison/daily_differences.xlsx")
daily_cleaned <- read.csv("C:/Users/SMcRae/udacity-git-course/masters_projects/rainfall_comparison/Daily_cleaned2.csv")
View(monthly)
View(daily)
...
If BOM needed another source of accurate rainfall data for the area, due to technical failure or a similiar issue, KM would be able to provide a substitute.
